...
let favoriteThing = "a thing";
console.log(typeof favoriteThing);

// You heard a new song that became your favorite.
// Reassign the variable "favoriteSong"
favoriteSong = "I really don't know, a good one";
...
console.log("My name is " + name + " and my favoriteSong is " + favoriteSong);
console.log(`My name is ${name} and my favoriteSong is ${favoriteSong}`);
