// const names = ["kyle", "tiffany", "mumtaz"];

// for (let name of names) {
//   console.log(`${name} is a great coder!`);
// }

// names.forEach(name => console.log(`${name} is a savvy coder!`));

// const nums = [1, 2, 3];
// const doubled = [];

// nums.forEach(num => doubled.push(num * num));
// console.log(doubled);
...
const locations = [];
data.forEach(user =>
  locations.push([user.address.geo.lat, user.address.geo.lng])
);
