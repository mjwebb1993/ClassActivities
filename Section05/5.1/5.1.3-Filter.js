...
console.log("incomplete tasks array:", incompleteTasks);

// filter for user 6's tasks
const userSixTasks = data.filter(task => task.userId === 6);
console.log("user Six Tasks", userSixTasks);

// filter for user 6's completed tasks
const userSixCompletedLongVersion = data.filter(
  task => task.userId === 6 && task.completed === true
);

const userSixCompleted = userSixTasks.filter(task => task.completed === true);
console.log("user six completed tasks", userSixCompleted);

// filter for tasks with a title less than 24 characters long
const shortTitles = data.filter(task => task.title.length < 24);
console.log("short titles:", shortTitles);
