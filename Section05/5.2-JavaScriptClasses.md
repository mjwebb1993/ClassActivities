...
<br>
Object Oriented Programming enables you to more easily access the data for your web application. Having data displayed in this way allows you to create a category of objects (such as descriptions of available sweaters from a store's web application).
</br>
...
<!-- [5.2.3-Classes.js](Activities/5.2-Activities/5.2.3-Classes.js) -->
